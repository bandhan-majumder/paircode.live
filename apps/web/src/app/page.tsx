...
export default function Home() {
	return (
		<div className="container mx-auto max-w-[85vw] px-4 py-2">
			...
			<div className="mt-10" style={{ position: 'relative', paddingBottom: '56.25%', height: 0 }}><iframe src="https://www.loom.com/embed/8b6df15c6b2445e1a60127266ac9cca5" frameBorder="0" width={500} className="p-20" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}></iframe></div>
